...
Public Sub UsuarioAtacaNpc(ByVal UserIndex As Integer, ByVal NpcIndex As Integer)
    ...
    If UserImpactoNpc(UserIndex, NpcIndex) Then
        ...
        End If
    Else
        Call WriteChatOverHeadHit(SendTarget.ToPCArea, "*Fallas*", UserList(UserIndex).Char.CharIndex, 0, 0, 255)
...
Public Sub UsuarioAtacaUsuario(ByVal AtacanteIndex As Integer, ByVal VictimaIndex As Integer)
    ...
    With UserList(AtacanteIndex)
        ...
        Else
            Call WriteChatOverHeadHit(SendTarget.ToPCArea, "*Fallas*", UserList(AtacanteIndex).Char.CharIndex, 0, 0, 255)
...
Public Sub UserDañoUser(ByVal AtacanteIndex As Integer, ByVal VictimaIndex As Integer)
    ...
    With UserList(AtacanteIndex)
        ...
        Call WriteUserHitUser(AtacanteIndex, VictimaIndex, daño)
...
'***************************************************
    ...
    If Not esRene(attackerIndex) And Not esRene(VictimIndex) Then
...
'***************************************************
    ...
    If (esCiuda(VictimIndex)) And (esArmada(attackerIndex)) Or (esArmada(attackerIndex) And esArmada(VictimIndex)) Then
        Call WriteConsoleMsg(attackerIndex, "Para poder atacar ciudadanos de un mismo ejercito escribe /RETIRAR. Este como consecuencia te quedaras en estado renegado.", FontTypeNames.FONTTYPE_WARNING)
        PuedeAtacar = False
        Exit Function
    End If
