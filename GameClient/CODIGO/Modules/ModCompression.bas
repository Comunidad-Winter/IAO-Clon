...
Private Const PASSWORD  As Long = 373246
Private Const EXTENSION As String = ".eo"
...
Public Function Extract_All_Files(ByVal file_type As resource_file_type, _
       ...
       'Set up the error handler
        ...
        Select Case file_type
                ...
                Case MP3
                        ...
                        Else
                                SourceFilePath = resource_path & "\Music_HD" & EXTENSION
                        End If
                ...
                Case Wav
                        ...
                        Else
                                SourceFilePath = resource_path & "\Sound_HD" & EXTENSION
                        End If
                ...
                Case Scripts
                        ...
                        Else
                                SourceFilePath = resource_path & "\Init" & EXTENSION
                        End If
       ...
       'Extract the FILEHEADER
        ...
        FileHead.lngFileSize = FileHead.lngFileSize - PASSWORD
...
Public Function Compress_Files(ByVal file_type As resource_file_type, _
       ...
       Select Case file_type
               ...
               Case graphics
                       ...
                       OutputFilePath = dest_path & "Graphics" & EXTENSION
 
               Case MP3
                       SourceFilePath = resource_path & MP3_PATH
                       SourceFileExtension = ".mp3"
                       OutputFilePath = dest_path & "Musics" & EXTENSION
...
On Local Error GoTo ErrHandler
    ...
    'Find the Info Head of the desired file
    InfoHead = File_Find(App.path & "\Resources\Graficos.eo", file_name)
    
    If InfoHead.strFileName = "" Or InfoHead.lngFileSize = 0 Then Exit Function

    'Open the binary file
    handle = FreeFile
    Open App.path & "\Resources\Graficos.eo" For Binary Access Read Lock Write As handle
